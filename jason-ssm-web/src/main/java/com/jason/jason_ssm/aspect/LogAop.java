package com.jason.jason_ssm.aspect;

import com.jason.jason_ssm.controller.SysLogController;
...
public class LogAop {
    ...
    @Before("execution(* com.jason.jason_ssm.controller.*.*(..))")
    ...
    @After("execution(* com.jason.jason_ssm.controller.*.*(..))")
